...
# y devuelve una nueva lista que contiene al principio todos los elementos de
# L para los que f devuelve True, y al final el resto de los elementos.
# No es necesario mantener el orden relativo de los elementos en cada grupo.
